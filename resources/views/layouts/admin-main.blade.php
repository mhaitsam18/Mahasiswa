...
<head>
    ...
    {{-- <link rel="shortcut icon" href="/assets/img/logos/Mahasiswa.png" /> --}}
...
<body>
    <div class="main-wrapper">
        ...
        <div class="flash-data" data-success="{{ session()->get('success') }}"
            data-error="@if ($errors->any()) Terjadi kesalahan, periksa kembali data yang Anda masukkan! @else{{ session()->get('error') }}@endif"
        ...
        <div class="page-wrapper">
            ...
            <footer
                ...
                <p class="text-muted mb-1 mb-md-0">Copyright © 2023 <a href="https://www.nobleui.com"
                        target="_blank">Mahasiswa</a>.</p>
                <p class="text-muted">Handcrafted By Reza With <i class="mb-1 text-primary ms-1 icon-sm"
