        ...
        <div class="col-lg-12 col-xl-12 stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="/admin/mahasiswa" method="post" enctype="multipart/form-data" class="row">
                        @csrf
                        ...
                        <div class="mb-3 p-2 row">
                            <div class="col">
                                ...
                                <input type="text" class="form-control @error('kecamatan') is-invalid @enderror"
                                    id="kecamatan" name="kecamatan" autofocus value="{{ old('kecamatan') }}">
                                @error('kecamatan')
                                    <div class="text-danger">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="mb-3 p-2 row">
                            <div class="col">
                                ...
                                <input type="text" class="form-control @error('nomor_telepon') is-invalid @enderror"
                                    id="nomor_telepon" name="nomor_telepon" autofocus value="{{ old('nomor_telepon') }}">
                                @error('nomor_telepon')
                                    <div class="text-danger">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="mb-3 p-2">
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="kewarganegaraan" id="radio_wni"
                                    value="WNI Asli" @checked('WNI Asli' == old('kewarganegaraan'))>
                                <label class="form-check-label" for="radio_wni">WNI Asli</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="kewarganegaraan"
                                    id="radio_wni_keturunan" value="WNI Keturunan" @checked('WNI Keturunan' == old('kewarganegaraan'))>
                                <label class="form-check-label" for="radio_wni_keturunan">WNI
                                    Keturunan</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="kewarganegaraan" id="radio_wna"
                                    value="WNA" @checked('WNA' == old('kewarganegaraan'))>
                        ...
                        <div class="mb-3 p-2 row">
                            <div class="col">
                                ...
                                <select class="form-select @error('provinsi_tempat_lahir') is-invalid @enderror"
                                    ...
                                    <option value="" selected disabled>Pilih Provinsi</option>
                                    @foreach ($data_provinsi as $provinsi)
                                        <option value="{{ $provinsi->provinsi }}" @selected($provinsi->provinsi == old('provinsi_tempat_lahir'))>
                                            {{ $provinsi->provinsi }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="mb-3 p-2">
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="status_menikah"
                                    id="radio_belum_menikah" value="Belum Menikah" @checked('Belum Menikah' == old('status_menikah'))>
                                <label class="form-check-label" for="radio_belum_menikah">Belum
                                    Menikah</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="status_menikah" id="radio_menikah"
                                    value="Menikah" @checked('Menikah' == old('status_menikah'))>
                                <label class="form-check-label" for="radio_menikah">Menikah</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="status_menikah"
                                    id="radio_lain_lain" value="Lain-lain (Janda/Duda)" @checked('Lain-lain (Janda/Duda)' == old('status_menikah'))>
                        ...
                        <div class="mb-3 p-2">
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="agama" id="agama_islam"
                                    value="Islam" @checked('Islam' == old('agama'))>
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="agama" id="agama_katolik"
                                    value="Katolik" @checked('Katolik' == old('agama'))>
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="agama" id="agama_kristen"
                                    value="Kristen" @checked('Kristen' == old('agama'))>
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="agama" id="agama_hindu"
                                    value="Hindu" @checked('Hindu' == old('agama'))>
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="agama" id="agama_budha"
                                    value="Budha" @checked('Budha' == old('agama'))>
                                <label class="form-check-label" for="agama_budha">Budha</label>
                            </div>

                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="agama" id="agama_lainlain"
                                    value="Lain-lain" @checked('Lain-lain' == old('agama'))>
